  ...
  const reasons = [
    {
      ...
      description: "35+ years of combined experience in computer repairs. Our skilled team has handled thousands of cases with expertise and professionalism.",
      icon: <Users className="w-8 h-8" />
    },
    {
      title: "Fast Service",
      description: "Same-day or next-day repairs for most issues. We understand your time is valuable and work efficiently without compromising quality.",
      icon: <Zap className="w-8 h-8" />
    },
    {
      title: "High-Quality Parts",
      description: "Only genuine and reliable components used in repairs. We source from trusted manufacturers to ensure longevity and performance.",
      icon: <Package className="w-8 h-8" />
    },
    {
      title: "Affordable & Transparent Pricing",
      description: "No hidden charges. We provide detailed quotations upfront and discuss costs before proceeding with any repair work.",
      icon: <DollarSign className="w-8 h-8" />
    },
    {
      title: "Trusted by Local Businesses",
      description: "Preferred service provider for homes, offices, and businesses in the region. Strong reputation built on consistent quality and reliability.",
      icon: <Award className="w-8 h-8" />
    },
    {
      title: "Warranty on Repairs",
      description: "All repairs come with warranty coverage. We stand behind our work and ensure your satisfaction and device reliability.",
